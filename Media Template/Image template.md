...
Brief:
  ...
  Deliverable:
    ...
    DurationSec: "{{e.g., 8}}"              # Only for video/audio
    FrameRateFPS: "{{e.g., 24}}"            # Only for video
...
Constraints:
  ...
  MustAvoid: ["{{artifacts, clichés, forbidden motifs, IP, etc.; 10+ negatives}}"]
  Safety: "{{copyright/privacy/brand/ethics}}"
Evaluation:
  SuccessCriteria: ["{{pass/fail checks: recognizability, brand, clarity}}"]
