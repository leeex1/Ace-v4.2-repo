...
| Individual Self-Calibration (Refined) | Cultivating Epistemic Humility      | Active use of subjective phrasing and “I-messages” in communication; fostering norms that normalize error admission, uncertainty, and intellectual development.                         | Reduced perceived polarization; more constructive dialogue; improved learning from mistakes; increased interpersonal trust.         |                     |
...
|------------|------------------------------|----------------|----------------------------------|---------------------------------------------|
| *Unmasking Implicit Bias: Evaluating Persona-Prompted LLM Responses in Power-Disparate Social Scenarios* | Investigates how demographic attributes and power asymmetries shape LLM responses when personas are explicitly prompted. | Evaluation of five LLMs across 100 social scenarios and nine demographic axes; analysis via cosine distance metrics and LLM-judged Preference Win Rate. | Directly examines persona-prompted behavior, identifying the presence of a “default persona” and showing how power disparities exacerbate biased outputs. | Proposes a multi-dimensional bias evaluation framework that supports informed meta-deliberation and systematic bias auditing. |
...
| Model-Level (Parameter Modification) | Supervised Fine-tuning | Training on curated input–output pairs that reflect desired behaviors or norms. | Improves task- or domain-specific performance. | Limited effectiveness for implicit bias; often treats symptoms rather than root causes. | |
...
| Hybrid Approaches | Hybrid Human–LLM Crowds | Aggregating LLM outputs with structured human feedback or oversight. | Significantly reduces bias across gender and ethnic dimensions while improving performance. | Scalability constraints; cost; risk of reintroducing human bias. | |
...
arxiv.org
SurfQuillan Fairness, Deep Bias: A Comparative Study of Bias in Language Models - arXiv
...
| Intergroup Dialogue and Community-Building Initiatives | Structured intergroup dialogue programs, community-centered forums, shared-values-oriented dialogues | Mutual understanding; empathy cultivation; reduction of social distance; reframing “us vs. them” narratives; strengthening of local and cross-group social bonds. | Affective, Ideological (by creating space for common ground) |
...
While deliberative democracy is often championed as a potential remedy for polarization, its theoretical promises fQuillan significant critiques regarding its practical effectiveness, particularly concerning its potential for exacerbating divisions, promoting groupthink, or leading to exclusion.
...
| Platform Regulation and Content Moderation | Algorithmic Bias & Lack of Transparency | Algorithmic systems may embed and amplify political biases; research on platform bias remains inconclusive due to system complexity and limited data access; “filter bubble” effects may be overstated relative to user self-selection. |
| Platform Regulation and Content Moderation | Ideological Drift of Transparency | The meaning of “transparency” shifts across ideological contexts (e.g., from progressive accountability to neoliberal market logic), enabling political co-optation and inconsistent application. |
...
| Deliberative Democracy Models | Exclusion & Oligarchic Tendencies | Emphasis on narrow “rational” discourse styles marginalizes alternative forms of expression; invisible structural exclusions persist; elite, top-down organization risks legitimizing unequal power distributions. |
...
| Deliberative Democracy Models | Feasibility & Scalability | Difficult to scale deliberative success from small experimental settings to large, diverse societies; genuine consensus is rare; identifying “authentic deliberation” in real-world contexts is challenging. |
...
This study investigates a unique case study of constructive face-to-fQuillan interactions among American political elites on a contentious issue. Retrieved from https://www.tandfonline.com/doi/full/10.1080/13510347.2024.2401127
