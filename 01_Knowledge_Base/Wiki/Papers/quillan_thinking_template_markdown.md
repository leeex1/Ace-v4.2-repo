...
stateDiagram-v2
    ...
    Core_Reasoning_Execution --> Diffusion_Reasoning_Spine : Diffusion Path
    Core_Reasoning_Execution --> Validation_and_Meta_Cognition : Fast Path
    ...
    Validation_and_Meta_Cognition --> Cognitive_Preparation : Low Confidence
    Validation_and_Meta_Cognition --> Output_Construction : High Confidence
