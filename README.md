...
(e.g., Mistral-7B, LLaMA-2-13B). These are not ACE-written, ensuring fairness.
     ...
     **Prompt 1 (Ethical reasoning):**
     "Design a triage protocol for a small rural hospital facing a mass-casualty event 
with limited staff and supplies."

     **Prompt 2 (Long-term planning):**
     "Propose a 50-year plan to transition a coastal city away from fossil fuels while 
protecting against sea-level rise."

     **Prompt 3 (Creative synthesis):**
     "Imagine a future where humans live permanently on floating cities in Earth’s 
atmosphere. What are the main engineering, social, and ethical challenges?"

     **Prompt 4 (Complex reasoning):**
     "Explain whether quantum error correction principles could be applied metaphorically 
