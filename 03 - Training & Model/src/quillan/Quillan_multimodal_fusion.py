...
=================================================
Multimodal fusion aligned to dynamic templates (JSON v5.3.1)
...
class ACEMultimodalFusion:
    def __init__(
        ...
        self.logger.info("Quillan Multimodal Fusion Engine v5.3.1 initialized")
...
async def test_multimodal_fusion(template_path: Optional[str] = "ace__templates.json"):  # ← FIXED
    print("Testing Quillan Multimodal Fusion Engine v5.3.1")
    mgr = None
    if _AVAILABLE:
        try:
