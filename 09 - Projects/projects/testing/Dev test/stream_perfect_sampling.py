...
def generate_stream(prompt, max_tokens=150, temp=0.7, top_p=0.9, top_k=40, penalty_sub=3.5):
...
for p in prompts:
    generate_stream(p, max_tokens=140, temp=0.7, top_p=0.9, top_k=40, penalty_sub=3.5)
