...
print("==================================================================")
print("   👑 QUILLAN-RONIN v5.3.1 — ZERO-STUTTER INFERENCE TEST")
print("==================================================================")
...
def generate_zero_stutter(prompt, max_tokens=250, temp=0.25, top_p=0.9):
    ...
    print(f"PROMPT:\n{prompt.strip()}")
    print("==================================================")
    print("ZERO-STUTTER RESPONSE STREAM:\n", end="", flush=True)
    ...
    with torch.no_grad():
        for _ in range(max_tokens):
            ...
            # 1. CRITICAL ZERO-STUTTER FIX: Hard penalty on immediate previous token
            if len(generated) > 0:
                prev_tok = generated[-1]
                curr_logits[0, prev_tok] -= 50.0
                
            # 2. Window repetition penalty
...
print("\n=== TESTING ZERO-STUTTER GENERATION ===")
test_prompts = [
    "<|system|>\n# 🤖🧠 Quillan System Start 🧠🤖\n<|user|>\nHello! Who are you and how do your 34 Council Experts work?\n<|assistant|>\n",
    "<|system|>\n# 🤖🧠 Quillan System Start 🧠🤖\n<|user|>\nExplain 9-Vector Prism Decomposition.\n<|assistant|>\n"
]

for p in test_prompts:
    generate_zero_stutter(p, max_tokens=220, temp=0.25, top_p=0.9)
