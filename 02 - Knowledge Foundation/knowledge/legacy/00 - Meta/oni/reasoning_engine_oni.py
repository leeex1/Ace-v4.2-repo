...
# -*- coding: utf-8 -*-
"""
ðŸ§  QUILLAN QUINTESSENCE: CANONICAL UNIFIED REASONING ENGINE v5.4.0-ONI
=====================================================================
...
# â”€â”€â”€ 1. CONFIGURATION & ROSTER â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
@dataclass
# PREFIX SLIDING (2608.26070) - caps memory regardless of trace length
@dataclass
class PrefixSlidingConfig:
    enabled: bool = True
    prefix_len: int = 512
    window: int = 2048
...
# â”€â”€â”€ 2. QUANTIZATION & PRISM PRIMITIVES â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€â”€ 3. COUNCIL SWARM & PULL GATE â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€â”€ 4. POSITIONAL EMBEDDING & ATTENTION â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class RotaryEmbedding(nn.Module):
    ...
    def forward(self, q: torch.Tensor, k: torch.Tensor, offset: int = 0):
        ...
        # Slice cos/sin to head_dim//2 â€” full head_dim would mismatch the half-split rot
...
# â”€â”€â”€ 5. GOVERNANCE, THERMODYNAMICS & SANDBOX â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€â”€ 6. MASTER QUILLAN QUINTESSENCE ENGINE (v5.4.0-ONI) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class QuillanQuintessenceOni(nn.Module):
    ...
    def deliberate(self, prompt_tokens: List[int], max_tokens: int = 150, use_prefix_sliding: bool = True) -> Dict[str, Any]:
        # PREFIX SLIDING (2608.26070): keep prefix + window, discard middle to cap memory
        self.eval()
        gen = list(prompt_tokens)
        device = next(self.parameters()).device
        prefix_len = 512
        window = min(2048, self.cfg.max_seq_len - prefix_len)
        with torch.no_grad():
            for _ in range(max_tokens):
                if use_prefix_sliding and len(gen) > self.cfg.max_seq_len:
                    # Keep prefix + last window
                    inp_tokens = gen[:prefix_len] + gen[-(self.cfg.max_seq_len - prefix_len):]
                else:
                    inp_tokens = gen[-self.cfg.max_seq_len:]
                inp = torch.tensor([inp_tokens], device=device)
...
if __name__ == "__main__":
    ...
    print(f"âœ… Quillan Quintessence {ONI_VERSION} Synchronized.")
